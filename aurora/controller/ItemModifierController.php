...
{
    protected $model = '\aurora\model\ItemModifier';
    ...
    function add() {
        ...
        $obj->priority_level = $obj->getNextPriorityLevel('item_id');
    ...
    function setPriorityLevel($id) {
        ...
        // Update object
        $rowsAffected = $obj->setPriorityLevel($new_priority_level, 'item_id');
