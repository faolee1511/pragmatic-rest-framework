...
class ModifierOptionController
    extends BaseControllerAbstract
{
    protected $model = '\aurora\model\ModifierOption';
    ...
    function add() {
        ...
        $obj->priority_level = $obj->getNextPriorityLevel('modifier_id');
    ...
    function setPriorityLevel($id) {
        ...
        // Update object
        $rowsAffected = $obj->setPriorityLevel($new_priority_level, 'modifier_id');
