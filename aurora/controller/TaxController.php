...
{
    protected $model = '\aurora\model\Tax';
    ...
    */
    ...
    function add() {
        ...
        $obj->priority_level = $obj->getNextPriorityLevel('tax_profile_id');
    ...
    function setPriorityLevel($id) {
        ...
        // Update object
        $rowsAffected = $obj->setPriorityLevel($new_priority_level, 'tax_profile_id');
