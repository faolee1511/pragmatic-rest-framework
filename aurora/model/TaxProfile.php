...
{
    // Class constants
    const TABLE_NAME = 'tax_profile';
    const PRIMARY_KEY = 'tax_profile_id';
    const TABLE_ALIAS = 'base_table';
    const ROUTE = 'tax_profiles';
    const MODULE = 'tax';

    // Class properties
    public $branch_id = '';
    public $tax_profile_id = '';
    public $tax_profile_name;
    public $is_public;
    public $status;
    public $created_on;
    public $created_by;
        ...
        $property_settings = array(
            ...
            'tax_profile_name' => array(
                ...
                'custom' => [array (
                    ...
                    'parameter' => array (
                        'tax_profile_name',
                        $this->tax_profile_name,
                    ),
                    'error_message' => 'Profile name must be unique.',
                )],
            ),
            'is_public' => array(
                'required' => true,
    ...
    protected static function getQuery($query_section) {
        ...
        switch ($query_section) {
            ...
            case 'search':
                return array(
                    "$table_alias.tax_profile_name",
                );

            //  ORDER
            case 'order':
                return array(
                    "$table_alias.tax_profile_name" => 'ASC',
                );
    ...
    protected static function getChildDataSettings() {
        ...
        return array (
            'taxes' => array (
                'model' => '\aurora\model\Tax',
                'key' => 'tp_tax_profile_id',
            )
        );
    }
